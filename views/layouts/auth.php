                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            <a href="/" class="text-nowrap logo-img text-center d-block py-3 w-100">
                                <img src="../assets/images/logos/discography.png" width="180" alt="Discography Logo">
                            </a>
                            <p class="text-center">Discography</p>

                            <!-- Renderovani sadržaj view-a -->
                            {{ renderSection }}
...
if ($success !== false) {
    $success = htmlspecialchars($success, ENT_QUOTES, 'UTF-8');
    echo "
        <script>
